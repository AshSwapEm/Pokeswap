...
import { ROUTER_ADDRESS,BallsToken ,BallsBar,BallsReward} from '../constants'
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency, ETHER } from 'pokesdk'
...
// account is optional
export function getBallsRewardContract(_: number, library: Web3Provider, account?: string): Contract {
  return getContract(BallsReward, BallsRewardABI, library, account)
}

//BallsToken
export function getBallsTokenContract(_: number, library: Web3Provider, account?: string): Contract {
